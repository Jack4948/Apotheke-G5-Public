...
|Use Case      | [[UC003]] <<UC003>> Zugang über PIN
|Vorbedingung(en)      a|Arzthelferin steht vor dem Zugangssystem mit gültiger PIN.
|Ablauf      a|
Arzthelferin *Sarah* gibt die PIN *8234#* ein. +
...
Apothekenmitarbeiter erfasst die Bestellung, erstellt einen Bestellzettel mit ID 57321. +
...
|Ablauf      a|
Lieferdienst übernimmt Bestellung *#4711* für *Herrn Meyer, Halle,Zapfenstr.3*. +
