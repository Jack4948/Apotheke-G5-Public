...
Pflegesalben etc.). Daneben gibt es ein kleines chemisches Labor, wo auf Anforderung 
...
der Kasse eingelesen. Auf diese Weise wird der Posten auf die Kundenrechnung und 
...
=== Kontextdiagramm
image::models/images/Kontextdiagramm.png[]
=== Top-Level-Architektur
image::models/images/Top-Level-Architektur.png[]
